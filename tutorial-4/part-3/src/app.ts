import { LUT, ColorHSV, PalettedFill, lightningChart, AxisScrollStrategies, AxisTickStrategies, emptyLine, LegendBoxBuilders } from "@arction/lcjs";
...
const chart = lightningChart()
  ...
  .setTitle("Scrolling Heatmap Spectrogram Chart");
chart
  .getDefaultAxisX()
  .setTitle("Time")
